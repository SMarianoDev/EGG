Algoritmo sin_titulo
	Definir matrizA, matrizB, matrizC, vector Como Entero
	Dimension matrizA[3,3],matrizB[3,3],matrizC[3,3]
	Dimension vector[3]
	llenarMatriz(matrizA,matrizB,matrizC,vector)
FinAlgoritmo
SubProceso llenarMatriz(matrizA,matrizB,matrizC,vector)
	...
	mostrarMultiMatrizVector(matrizA,matrizB,matrizC,vector)
FinSubProceso
...
SubProceso mostrarMultiMatrizVector(matrizA,matrizB,matrizC,vector)
	Definir i,j,k,j2, multi, suma Como Entero
	para i <- 0 Hasta 2
	...
	para i <- 0 Hasta 2
		para j <- 0 Hasta 2
			multi = matrizC(i,j) * vector(j)
			Escribir Sin Saltar matrizC(i,j),"*", vector(j), " = ",multi," "
		FinPara
		Escribir ""
	FinPara
FinSubProceso
